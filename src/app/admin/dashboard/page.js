...
export default function AdminDashboard() {
  ...
  const addProduct = (category) => {
    const newProduct = {
      ...
      range: category === "2-Wheeler" ? "Upto-120 km" : "Upto-150 km",
      topSpeed: category === "2-Wheeler" ? "80 km/h" : undefined,
      ...
      <div style={{ display: "grid", gridTemplateColumns: "200px 1fr", gap: 20 }}>
        ...
        <div style={{ display: "grid", gap: 12 }}>
          ...
          <InputField
            ...
            disabled={!isEditing}
            placeholder="e.g., From ₹30,000/-"
          />

          {/* Battery Section (2W Only) */}
          {category === "2-Wheeler" && (
            <>
          ...
          <InputField
            ...
            disabled={!isEditing}
            placeholder="e.g., Rear, Front, AWD"
          />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <InputField
              ...
              onChange={(v) => setEditData({ ...editData, warranty: v })}
              disabled={!isEditing}
